#
# build.tcl: Tcl script for re-creating project 'kc705_hpc_max_tp'
#
#*****************************************************************************************
...
set design_name kc705_hpc_max_tp
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../HLS/axi_init"] [file normalize "$origin_dir/../HLS/eth_traffic_gen/proj_eth_traffic_gen/solution3"]" $obj
...
set file "[file normalize "$origin_dir/src/constraints/kc705-hpc.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/kc705-hpc.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/kc705-hpc.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7k325tffg900-2 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7k325tffg900-2 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
