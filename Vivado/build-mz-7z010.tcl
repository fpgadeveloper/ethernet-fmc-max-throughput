#
# build.tcl: Tcl script for re-creating project 'mz_7z010_max_tp'
#
#*****************************************************************************************
...
set design_name mz_7z010_max_tp
...
set_property -name "board_part" -value "em.avnet.com:microzed_7010:part0:1.2" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../HLS/axi_init/proj_axi_init/solution1"] [file normalize "$origin_dir/../HLS/eth_traffic_gen/proj_eth_traffic_gen/solution2"]" $obj
