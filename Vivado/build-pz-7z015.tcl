#
# build.tcl: Tcl script for re-creating project 'pz_7z015_qgige_max_tp'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/pz_7z015_qgige_max_tp"]"

# Create project
create_project pz_7z015_qgige_max_tp ./pz_7z015_qgige_max_tp

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects pz_7z015_qgige_max_tp]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7z015clg485-1 -flow {Vivado Synthesis 2016} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z015clg485-1 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
...
puts "INFO: Project created:pz_7z015_qgige_max_tp"
