#
# build.tcl: Tcl script for re-creating project 'pz_7z015_max_tp'
#
#*****************************************************************************************
...
set design_name pz_7z015_max_tp
...
# Create project
create_project $design_name $origin_dir/$design_name -part xc7z015clg485-1
...
set_property -name "board_part" -value "em.avnet.com:picozed_7015_fmc2:part0:1.2" -objects $obj
...
set file "[file normalize "$origin_dir/src/constraints/pzfmc-7z015-7z030.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/pzfmc-7z015-7z030.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/pzfmc-7z015-7z030.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7z015clg485-1 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z015clg485-1 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property used_in_simulation false [get_files ${design_name}_wrapper.v]
...
set_property used_in_synthesis false [get_files design_2_wrapper.v]
