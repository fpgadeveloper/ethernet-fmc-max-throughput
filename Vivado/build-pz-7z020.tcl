#
# build.tcl: Tcl script for re-creating project 'pz_7z020_qgige_max_tp'
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/pz_7z020_qgige_max_tp"]"

# Create project
create_project pz_7z020_qgige_max_tp ./pz_7z020_qgige_max_tp

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects pz_7z020_qgige_max_tp]
set_property "board_part" "em.avnet.com:picozed_7020:part0:1.0" $obj
...
puts "INFO: Project created:pz_7z020_qgige_max_tp"
