#
# build.tcl: Tcl script for re-creating project 'pz_7z020_max_tp'
#
#*****************************************************************************************
...
set design_name pz_7z020_max_tp
...
set_property -name "board_part" -value "em.avnet.com:picozed_7020_fmc2:part0:1.1" -objects $obj
...
set file "[file normalize "$origin_dir/src/constraints/pzfmc-7z010-7z020.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constraints/pzfmc-7z010-7z020.xdc"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/src/constraints/pzfmc-7z010-7z020.xdc"]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7z020clg400-1 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
