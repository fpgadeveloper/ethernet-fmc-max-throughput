...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {200} CONFIG.CLKOUT2_USED {true}  ] $clk_wiz_0
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_processing_system7_0_100M/dcm_locked]
  ...
  connect_bd_net -net gtx_clk_1 [get_bd_pins axi_ethernet_2/gtx_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins axi_ethernet_2/ref_clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_reset [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_processing_system7_0_100M/peripheral_reset]
